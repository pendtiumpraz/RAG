...
> keseluruhan ±8,8/10** (30 Jul: 8,7 · 28 Jul: 7,7 · 23 Jul: 5,3).
...
GB per chatbot** — dan titik runtuhnya ada di bawah angka itu.
...
| Area | Skor | Kurangnya |
|---|:---:|---|
| **Keandalan jalur CRUD** | 8,5 | **Area baru.** Enam kebuntuan kolam koneksi (Vercel `max: 1`) ditemukan & ditutup 1–2 Agu, dengan pemindai permanen yang menolak polanya kembali masuk. Sebelum ini kelasnya tak pernah diperiksa sama sekali. Pen-test eksternal belum |
...
bekerja. Assessment 2026-07-30 digantikan dokumen ini.*
