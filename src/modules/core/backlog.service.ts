...
const HUMAN: SeedItem[] = [
  { key: 'h-smtp', track: 'human', dimension: 'launch', size: 'S',
  ...
  { key: 'h-gateway', track: 'human', dimension: 'launch', size: 'S',
  ...
  { key: 'h-drive-apikey', track: 'human', dimension: 'feature', size: 'S',
  ...
  { key: 'h-ms-credentials', track: 'human', dimension: 'feature', size: 'S',
  ...
  { key: 'h-google-oauth', track: 'human', dimension: 'launch', size: 'M',
  ...
  { key: 'h-pricing', track: 'human', dimension: 'feature', size: 'S',
  ...
  { key: 'h-mailbox', track: 'human', dimension: 'launch', size: 'S',
  ...
  { key: 'h-pentest', track: 'human', dimension: 'launch', size: 'L',
  ...
  { key: 'h-dpa', track: 'human', dimension: 'launch', size: 'M',
  ...
  { key: 'h-casa', track: 'human', dimension: 'feature', size: 'M',
  ...
  { key: 'h-uptime', track: 'human', dimension: 'launch', size: 'S',
  ...
  { key: 'h-redis', track: 'human', dimension: 'launch', size: 'S',
  ...
  { key: 'h-demo-video', track: 'human', dimension: 'uiux', size: 'M',
  ...
  { key: 'h-support', track: 'human', dimension: 'launch', size: 'S',
...
const AGENT: SeedItem[] = [
  ...
  { key: 'a-apikey', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-hybrid', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-kb-upload', track: 'agent', dimension: 'feature', size: 'M',
  ...
  { key: 'a-widget-persist', track: 'agent', dimension: 'uiux', size: 'S',
  ...
  { key: 'a-chat-controls', track: 'agent', dimension: 'uiux', size: 'S',
  ...
  { key: 'a-eval', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-injection-eval', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-chunk', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-blocks-table', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-conv-search', track: 'agent', dimension: 'uiux', size: 'M',
  ...
  { key: 'a-alerting', track: 'agent', dimension: 'feature', size: 'M',
  ...
  { key: 'a-dashboard-trend', track: 'agent', dimension: 'uiux', size: 'S',
  ...
  { key: 'a-invoice', track: 'agent', dimension: 'feature', size: 'M',
  ...
  { key: 'a-memory-chat', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-2fa', track: 'agent', dimension: 'feature', size: 'M',
  ...
  { key: 'a-ratelimit', track: 'agent', dimension: 'launch', size: 'M',
  ...
  { key: 'a-a11y', track: 'agent', dimension: 'uiux', size: 'M',
  ...
  { key: 'a-mobile', track: 'agent', dimension: 'uiux', size: 'M',
  ...
  { key: 'a-sync-progress', track: 'agent', dimension: 'uiux', size: 'M',
  ...
  { key: 'a-helpcenter', track: 'agent', dimension: 'launch', size: 'M',
  ...
  { key: 'a-empty-tour', track: 'agent', dimension: 'uiux', size: 'M',
  ...
  { key: 'a-onprem-docs', track: 'agent', dimension: 'feature', size: 'M',
  ...
  { key: 'a-mcp', track: 'agent', dimension: 'agentic', size: 'M',
  ...
  { key: 'a-rbac-div', track: 'agent', dimension: 'feature', size: 'M',
  ...
  { key: 'a-confidence', track: 'agent', dimension: 'agentic', size: 'S',
  ...
  { key: 'a-moderation', track: 'agent', dimension: 'agentic', size: 'S',
  ...
  { key: 'a-runbook', track: 'agent', dimension: 'launch', size: 'M',
  ...
  { key: 'a-status', track: 'agent', dimension: 'launch', size: 'S',
  ...
  { key: 'a-theme-preset', track: 'agent', dimension: 'feature', size: 'S',
  ...
  { key: 'a-dark', track: 'agent', dimension: 'uiux', size: 'S',
  ...
  { key: 'a-landing-demo', track: 'agent', dimension: 'uiux', size: 'M',
  ...
  { key: 'a-funnel', track: 'agent', dimension: 'launch', size: 'M',
  ...
  { key: 'a-sso', track: 'agent', dimension: 'feature', size: 'L',
  ...
  { key: 'a-connectors', track: 'agent', dimension: 'feature', size: 'L',
...
async function ensureSeeded(): Promise<void> {
  ...
  await db.insert(backlogItems).values(
    missing.map((s, i) => ({
      ...
      why: s.why, size: s.size, blocked: s.blocked ?? null,
...
export const backlogService = {
  ...
  async create(actor: Actor, input: {
    track: Track; dimension: Dimension; title: string; why: string; size: Size; blocked?: string;
  }): Promise<BacklogRow> {
