...
export interface NalarEvents {
  ...
  'document.ingested':{ tenantId: string; chatbotId: string; documentId: string; chunks: number };
  'document.deleted': { tenantId: string; chatbotId: string; documentId: string };
  'conversation.turn':{ tenantId: string; chatbotId: string; conversationId: string };
  'source.connected': { tenantId: string; chatbotId: string; sourceId: string; kind: string };
